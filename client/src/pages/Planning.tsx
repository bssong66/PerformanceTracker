      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === 'tasks' && (
          <div className="space-y-6">
            {/* Header */}
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">할일 관리</h2>
            </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Select value={newTask.projectId?.toString() || 'none'} onValueChange={(value) => 
                      setNewTask(prev => ({ ...prev, projectId: value === 'none' ? null : Number(value) }))}>
                      <SelectTrigger>
